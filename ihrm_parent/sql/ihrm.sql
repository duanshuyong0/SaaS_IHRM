...
CREATE TABLE `atte_attendance`  (
  ...
  `adt_in_time` datetime NULL DEFAULT NULL COMMENT '上班考勤时间',
  ...
  `adt_out_time` datetime NULL DEFAULT NULL COMMENT '下班考勤时间',
...
CREATE TABLE `atte_attendance_config`  (
  ...
  `company_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公司ID',
  `department_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '部门ID',
  `morning_start_time` time NULL DEFAULT NULL COMMENT '上午打卡时间',
  `morning_end_time` time NULL DEFAULT NULL COMMENT '上午打卡时间',
  `afternoon_start_time` time NULL DEFAULT NULL COMMENT '下午打卡时间',
  `afternoon_end_time` time NULL DEFAULT NULL COMMENT '下午打卡时间',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_date` datetime NULL DEFAULT NULL,
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `update_date` datetime NULL DEFAULT NULL,
...
CREATE TABLE `atte_day_off_config`  (
  ...
  `company_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公司ID',
  `department_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '部门ID',
  `latest_effect_date` datetime NULL DEFAULT NULL COMMENT '调休最后有效日期',
...
CREATE TABLE `atte_extra_duty_rule`  (
  ...
  `rule_start_time` time NULL DEFAULT NULL COMMENT '规则生效每日开始时间',
  `rule_end_time` time NULL DEFAULT NULL COMMENT '规则生效每日结束时间',
...
CREATE TABLE `bs_user`  (
  ...
  `time_of_dimission` datetime NULL DEFAULT NULL COMMENT '离职时间',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of bs_user
-- ----------------------------
INSERT INTO `bs_user` VALUES ('1063705482939731968', '13800000001', 'cgx', '88012a09484c94fcec9e65b2377c44b9', NULL, '2018-11-17 16:08:44', '', '2018-11-01 08:00:00', 1, '', NULL, NULL, '2018-11-01 00:00:00', 0, '', '', '', 'saasAdmin', NULL, NULL);
INSERT INTO `bs_user` VALUES ('1063705989926227968', '13800000002', 'arvinyl', 'c8b7722b1139bb9b346409e503302e82', 1, '2018-11-17 16:10:45', '1175310929766055936', '2018-11-02 08:00:00', 1, '9002', NULL, NULL, '2018-11-30 00:00:00', 0, '1', '传智播客', '总裁办', 'coAdmin', 'http://pkbivgfrm.bkt.clouddn.com/1063705989926227968?t=1545788007343', '2019-08-17 16:10:45');
INSERT INTO `bs_user` VALUES ('1066370498633486336', '13800000003', 'zbz', '14af10ffa3798486632a79cbbf469376', 1, NULL, '1175311213774962688', '2018-11-04 08:00:00', 1, '111', NULL, NULL, '2018-11-20 00:00:00', 0, '1', '传智播客', '行政部', 'user', 'http://pkbivgfrm.bkt.clouddn.com/1066370498633486336?t=1545812322518', NULL);
INSERT INTO `bs_user` VALUES ('1071632760222810112', '13800000004', 'll', '456134d471010ecba14c6f89cac349ff', 1, NULL, '1175311267684352000', '2018-12-02 08:00:00', 1, '1111', NULL, NULL, '2018-12-31 00:00:00', 0, '1', '传智播客', '人事部', 'user', NULL, NULL);
INSERT INTO `bs_user` VALUES ('1074238801330704384', '13400000001', 'a01', '80069fc2872ce3cf269053f4a84b2f0d', 1, '2018-12-16 17:44:22', '1175311466846683136', '2018-01-01 00:00:00', 1, '1001', NULL, NULL, NULL, 1, '1', '传智播客', '市场部', 'user', NULL, NULL);
INSERT INTO `bs_user` VALUES ('1074238801402007552', '13400000002', 'a02', 'a4f6437f96466ff2ad41dc8c46317e7f', 1, '2018-12-16 17:44:23', '1175311325720936448', '2018-01-01 00:00:00', 1, '1002', NULL, NULL, NULL, 1, '1', '传智播客', '财务部', 'user', NULL, NULL);
INSERT INTO `bs_user` VALUES ('1075383133106425856', '13500000001', 'test001', 'c8b7722b1139bb9b346409e503302e82', 1, NULL, '1175311373083017216', '2018-01-01 00:00:00', 1, '2001', NULL, NULL, NULL, 1, '1', '传智播客', '技术部', 'user', NULL, NULL);
INSERT INTO `bs_user` VALUES ('1075383135371350016', '13500000002', 'test002', 'becc21ed8df7975fc845c6c70f46c2dd', 1, NULL, '1175311418004013056', '2018-01-01 00:00:00', 1, '2002', NULL, NULL, NULL, 1, '1', '传智播客', '运营部', 'user', NULL, NULL);
INSERT INTO `bs_user` VALUES ('1075383135459430400', '13500000003', 'test003', '7321b9c9cfaa938abc7408147fc29441', 1, NULL, '1175311466846683136', '2018-01-01 00:00:00', 1, '2003', NULL, NULL, NULL, 1, '1', '传智播客', '市场部', 'user', NULL, NULL);
...
CREATE TABLE `em_positive`  (
  ...
  `date_of_correction` datetime NULL DEFAULT NULL COMMENT '转正日期',
...
INSERT INTO `em_user_company_personal` VALUES ('1063705989926227968', 'itcast', '13800000002', '2018-11-02T00:00:00.000+0000', 'test1', '1', '女', '2019-07-30T16:00:00.000Z', '本科', NULL, NULL, '1234567890', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '123', '123', '12', '333', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `proc_instance`  (
  ...
  `proc_apply_time` datetime NULL DEFAULT NULL COMMENT '申请时间',
  ...
  `proc_end_time` datetime NULL DEFAULT NULL COMMENT '结束流程时间',
...
-- ----------------------------
INSERT INTO `ss_archive` VALUES ('1240302152543498240', '1', '201908', NULL, 5744.87, 5744.87, 11489.74);
...
-- ----------------------------
INSERT INTO `ss_company_settings` VALUES ('1', 1, '201908');
...
INSERT INTO `ss_user_social_security` VALUES ('1063705989926227968', 0, 0, NULL, 1, 2, 10000, 3.00, 'xxxx', NULL, 10000, 0.12, 0.12, 12.00, 12.00, 'xxx12345', '2019-07-16 10:36:21', '2019-07-16 10:36:21', '2019-07-16 10:36:21', NULL, NULL, NULL, NULL);
